<template>
  <div class="medicine-drug">
    ...
    <el-dialog :title="dialogTitle" :visible.sync="dialogFormVisible" width="1000px">
      <el-tabs v-if="isEdit" value="basic" type="border-card">
      ...
      <el-form v-else ref="drugForm" :model="drugForm" :rules="rules" label-width="100px" size="small">
        <el-row :gutter="20">
          <el-col :span="8">
            <el-form-item label="药材编码" prop="drugCode">
              <el-input v-model="drugForm.drugCode" />
        ...
        <el-row :gutter="20">
          <el-col :span="12">
            <el-form-item label="规格" prop="spec">
              <el-input v-model="drugForm.spec" placeholder="如：10mg×100片" />
            </el-form-item>
          </el-col>
          <el-col :span="6">
            <el-form-item label="包装单位" prop="unit">
              <el-input v-model="drugForm.unit" placeholder="盒/瓶" />
            </el-form-item>
          </el-col>
          <el-col :span="6">
            <el-form-item label="基本单位" prop="baseUnit">
              <el-input v-model="drugForm.baseUnit" placeholder="片/粒/克" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="20">
          <el-col :span="8">
            <el-form-item label="转换率" prop="conversionRate">
              <el-input-number v-model="drugForm.conversionRate" :precision="4" :step="1" style="width: 100%" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="处方药分类" prop="prescriptionType">
